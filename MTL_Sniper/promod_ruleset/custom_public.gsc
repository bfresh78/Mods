main()
{
	...
	setDvar( "scr_sd_timelimit", 1.60 ); // [0->] (minutes)
	...
	setDvar( "scr_game_matchstarttime", 22 ); // [0->] (seconds)
	...
	setDvar( "promod_mc_loopdelay", 50 ); // [1->] (delay in seconds until it starting over)
	setDvar( "promod_mc_maxmessages", 4 ); // [1->] (set this equivalent to number of messages)
	setDvar( "promod_mc_message_1", "" );
	setDvar( "promod_mc_message_2", "" );
	setDvar( "promod_mc_message_3", "" );
	setDvar( "promod_mc_message_4", "" );
	setDvar( "promod_mc_messagedelay_1", 1 ); // [1->] (overrides default delay in seconds between messages, e.g special messages)
	setDvar( "promod_mc_messagedelay_2", 3 );
	setDvar( "promod_mc_messagedelay_3", 6 );
}