#include maps\mp\gametypes\_hud_util; 
  ...
  if( isDefined(game["PROMOD_KNIFEROUND"]) && game["PROMOD_KNIFEROUND"] ) matchStartText setText( "^0Knife ^1Round" ); 
  else matchStartText setText( "^5Starting In" ); 
  ...
  matchStartWish setText( "^0Faze ^1Promod" ); 
