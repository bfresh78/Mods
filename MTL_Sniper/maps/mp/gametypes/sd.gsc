...
intoSpawn(originA, anglesA)
{
	...
	if (roundspl==0)
	{
		self thread NotiText(self, "^0Welcome^5 " + self.name + "!", -95, 1.8, 3); 		
		wait 1;
		self thread NotiText(self, "^5U^0zivajte", -75, 1.6, 3); 		
		self thread NotiText(self, "^5S^0kin & ^7Music ^0by ^5LoCZy", -55, 1.6, 3);
		wait 0.2;
		self thread NotiText(self, "^5M^0odificion by ", -25, 1.6, 3);
		self thread NotiText(self, "^5Z^0aGGoreC ^7:D ", 1, 1.6, 3); 
		self thread NotiText(self, "^5L^0oCZy ", 24, 1.6, 3);
	}
}
